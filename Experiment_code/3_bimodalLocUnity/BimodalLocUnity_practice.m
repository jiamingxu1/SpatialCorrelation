...
out1FileName        = ['BimodalLocSeq_practice_sub', num2str(ExpInfo.subjID)];
...
ExpInfo.numTotalTrials               = ExpInfo.numReps * ExpInfo.numAVpairs; %25
...
for ii = 1:ExpInfo.numTotalTrials % one trial is one AV train (5 events)
    ...
    Bimodal_localization_practice_data = {ExpInfo, ScreenInfo, VSinfo, AudInfo, Response};
    save(out1FileName,'Bimodal_localization_practice_data');
