all_init = {'EN','GK','HL','RD','SL','JZ','MS'};
sIDs = [124 139 876 369 773 308 552];
...
for ii = 1:length(all_init) % EACH SUBJECT
    ...
    T = table(session,modality,vRateC,aRateC,vRateS,aRateS,dur,response);
    filesave = ['/Users/shannonlocke/GoogleDrive/PhD/Research/CodeWorkSpace/RateJNDinR/rateJNDdata_s' num2str(sIDs(ii)) '.txt'];
