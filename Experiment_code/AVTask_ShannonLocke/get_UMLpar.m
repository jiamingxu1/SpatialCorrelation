function [par] = get_UMLpar(xscale)
...
par.beta = struct(...
    'limits',[0.3 3.5] * xscale,...      %range of the parameter space for beta
    'N',60,...                %number of beta values. If this value is set to 1, then the mean of beta_limits would be the assumed beta and the beta parameter is not estimated.
    'scale','lin',...         %the linear or log spacing. Choose between 'lin' and 'log'.
...
par.lambda = struct(...
    'limits',0,...      %range of the parameter space for lambda
