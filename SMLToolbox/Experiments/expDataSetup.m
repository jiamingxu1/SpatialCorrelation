...
% experiment.
%
% [EXP,FSAVEFILE,TSAVEFILE] = expDataSetup(EXPNAME,SUBJECT,SESSION,CONDLABEL,RESTARTYN)
%
% -- INPUTS --
...
fSaveFile = [dataSavePath filesep fSaveFile '.mat']; % with directory

% Temp file name
tSaveFile = ['Temp_' subject '_' expName '_' condLabel '_' cSes '_' tStamp]; % File name
tSaveFile = [dataSavePath filesep tSaveFile '.mat']; % with directory
